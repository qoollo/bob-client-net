...
{
    public class BobConnectionParametersTests : BobTestsBaseClass
    {
        public BobConnectionParametersTests(Xunit.Abstractions.ITestOutputHelper output) : base(output) { }
